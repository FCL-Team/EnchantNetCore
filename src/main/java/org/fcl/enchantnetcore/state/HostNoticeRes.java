...
/** Texts for HostVpnService notifications (connecting/connected/fail variants). */
public class HostNoticeRes {
    ...
    public final String btnExit,         btnCopy;

    public HostNoticeRes(@DrawableRes int icon,
